...
Source0  : https://download.kde.org/stable/frameworks/6.5/kiconthemes-6.5.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.5/kiconthemes-6.5.0.tar.xz.sig
...
%setup -q -n kiconthemes-6.5.0
cd %{_builddir}/kiconthemes-6.5.0
pushd ..
cp -a kiconthemes-6.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723230044
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6IconThemes.so.6.5.0
/V3/usr/lib64/libKF6IconWidgets.so.6.5.0
...
/usr/lib64/libKF6IconThemes.so.6.5.0
/usr/lib64/libKF6IconWidgets.so.6
/usr/lib64/libKF6IconWidgets.so.6.5.0
