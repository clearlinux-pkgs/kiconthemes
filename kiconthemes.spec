...
Source0  : https://download.kde.org/stable/frameworks/5.98/kiconthemes-5.98.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.98/kiconthemes-5.98.0.tar.xz.sig
...
%prep
%setup -q -n kiconthemes-5.98.0
cd %{_builddir}/kiconthemes-5.98.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662997297
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IconThemes.so.5.98.0
