...
Version  : 5.103.0
Release  : 59
URL      : https://download.kde.org/stable/frameworks/5.103/kiconthemes-5.103.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.103/kiconthemes-5.103.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.103/kiconthemes-5.103.0.tar.xz.sig
...
%prep
%setup -q -n kiconthemes-5.103.0
cd %{_builddir}/kiconthemes-5.103.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676844676
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IconThemes.so.5.103.0
