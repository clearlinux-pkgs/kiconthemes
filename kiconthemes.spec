...
Version  : 5.110.0
Release  : 67
URL      : https://download.kde.org/stable/frameworks/5.110/kiconthemes-5.110.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.110/kiconthemes-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kiconthemes-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kiconthemes-5.110.0
cd %{_builddir}/kiconthemes-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694450900
mkdir -p clr-build
pushd clr-build
...
/usr/include/KF5/KIconThemes/KQuickIconProvider
...
/usr/include/KF5/KIconThemes/kquickiconprovider.h
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5IconThemes.so.5.110.0
...
/usr/lib64/libKF5IconThemes.so.5.110.0
