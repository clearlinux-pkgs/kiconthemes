...
Version  : 6.3.0
Release  : 82
URL      : https://download.kde.org/stable/frameworks/6.3/kiconthemes-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.3/kiconthemes-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/kiconthemes-6.3.0.tar.xz.sig
...
%setup -q -n kiconthemes-6.3.0
cd %{_builddir}/kiconthemes-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717787053
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6IconThemes.so.6.3.0
/V3/usr/lib64/libKF6IconWidgets.so.6.3.0
...
/usr/lib64/libKF6IconThemes.so.6.3.0
/usr/lib64/libKF6IconWidgets.so.6
/usr/lib64/libKF6IconWidgets.so.6.3.0
