...
Source0  : https://download.kde.org/stable/frameworks/5.60/kiconthemes-5.60.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.60/kiconthemes-5.60.0.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563062953
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IconThemes.so.5.60.0
