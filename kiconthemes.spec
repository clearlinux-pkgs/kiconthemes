...
Version  : 6.1.0
Release  : 79
URL      : https://download.kde.org/stable/frameworks/6.1/kiconthemes-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.1/kiconthemes-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.1/kiconthemes-6.1.0.tar.xz.sig
...
%setup -q -n kiconthemes-6.1.0
cd %{_builddir}/kiconthemes-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712967588
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6IconThemes.so.6.1.0
/V3/usr/lib64/libKF6IconWidgets.so.6.1.0
...
/usr/lib64/libKF6IconThemes.so.6.1.0
/usr/lib64/libKF6IconWidgets.so.6
/usr/lib64/libKF6IconWidgets.so.6.1.0
