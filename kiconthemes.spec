...
%setup -q -n kiconthemes-6.14.0
cd %{_builddir}/kiconthemes-6.14.0
pushd ..
cp -a kiconthemes-6.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747083934
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6IconThemes.so.6.14.0
/V3/usr/lib64/libKF6IconWidgets.so.6.14.0
...
/usr/lib64/libKF6IconThemes.so.6.14.0
/usr/lib64/libKF6IconWidgets.so.6
/usr/lib64/libKF6IconWidgets.so.6.14.0
