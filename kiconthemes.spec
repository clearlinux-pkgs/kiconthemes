...
Version  : 6.11.0
Release  : 94
URL      : https://download.kde.org/stable/frameworks/6.11/kiconthemes-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/kiconthemes-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kiconthemes-6.11.0.tar.xz.sig
...
BuildRequires : breeze-icons-dev
...
%setup -q -n kiconthemes-6.11.0
cd %{_builddir}/kiconthemes-6.11.0
pushd ..
cp -a kiconthemes-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739570107
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6IconThemes.so.6.11.0
/V3/usr/lib64/libKF6IconWidgets.so.6.11.0
/V3/usr/lib64/qt6/plugins/designer/kiconthemes6widgets.so
/V3/usr/lib64/qt6/plugins/kiconthemes6/iconengines/KIconEnginePlugin.so
/V3/usr/lib64/qt6/qml/org/kde/iconthemes/libiconthemesplugin.so
/usr/lib64/libKF6IconThemes.so.6
/usr/lib64/libKF6IconThemes.so.6.11.0
/usr/lib64/libKF6IconWidgets.so.6
/usr/lib64/libKF6IconWidgets.so.6.11.0
/usr/lib64/qt6/plugins/designer/kiconthemes6widgets.so
/usr/lib64/qt6/plugins/kiconthemes6/iconengines/KIconEnginePlugin.so
